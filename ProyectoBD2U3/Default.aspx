...
<body>
    ...
    <p>
        <asp:GridView ID="gvLibros" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="gvLibros_RowDeleting" OnRowEditing="gvLibros_RowEditing">
        </asp:GridView>
        </p>
        <p>
